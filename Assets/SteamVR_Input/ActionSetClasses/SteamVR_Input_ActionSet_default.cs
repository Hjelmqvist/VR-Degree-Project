...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean Toggle_Controllers
        {
            get
            {
                return SteamVR_Actions.default_Toggle_Controllers;
            }
        }
        ...
        public virtual SteamVR_Action_Single GrabGripStrength
        {
            get
            {
                return SteamVR_Actions.default_GrabGripStrength;
            }
        }
